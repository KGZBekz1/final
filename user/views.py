...
class registerView(APIView):
    def post(self, request):
        ...
        user = User.objects.create_user(
            username=serializer.validated_datadata['username'],
            email=serializer.validated_datadata['email'],
            password=serializer.validated_datadata['password'],
            is_active=False
        )
...
class SMSCodeConfirm(APIView):
    def post(self, request):
        ...
        try:
            sms = models.models.SMSCode.objects.get(sms_code=sms_code)
